...
class noOpenAIFilter(logging.Filter):
  def filter(self, record):
    return 'openai' not in record.name.lower()
...
class ReverieServer: 
  def __init__(self, 
    ...
    for persona_name in reverie_meta['persona_names']: 
      ...
      curr_persona.scratch.needs_init = True
      print(f"Set curr_time to: {curr_persona.scratch.curr_time}")
      print(f"needs_init is: {curr_persona.scratch.needs_init}")
