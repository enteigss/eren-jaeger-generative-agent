...
class Scratch: 
  def __init__(self, f_saved): 
    # Flag to indicate if it is the first day
    print("LOG: Initializing scratch")
    ...
    print("Set curr_time to:", self.curr_time)
    ...
    if check_if_file_exists(f_saved): 
      ...
      scratch_load["curr_time"] = "February 13, 2023, 00:00:00"
      # FOR EREN JAEGER
      ...
      print("LOG: curr_time at end of scratch init:", self.curr_time)
      # EREN JAEGER ONLY
      self.curr_time = datetime.datetime.now()
