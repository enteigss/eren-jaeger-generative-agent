...
import random
import logging
sys.path.append('generative_agents/reverie/backend_server')
## sys.path.append('../')
...
DEBUG_MODE = False  # Set to False to disable detailed logging
...
class Persona: 
  ...
  def move(self, maze, personas, curr_tile, curr_time):
    ...
    print(f"Current needs_init: {self.scratch.needs_init}")
    print(f"Current time before: {self.scratch.curr_time}")
    print(f"New time parameter: {curr_time}")
    ...
    # a new day. 
    new_day = False
    if self.scratch.needs_init: 
      print("First day triggered due to needs_init")
      new_day = "First day"
      self.scratch.needs_init = False
    elif (self.scratch.curr_time.strftime('%A %B %d')
          != curr_time.strftime('%A %B %d')):
      print("New day triggered")
      new_day = "New day"
